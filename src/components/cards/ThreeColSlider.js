...
const PrimaryButton = styled.a`
  ${tw`mt-5 tracking-wide font-semibold bg-primary-500 text-gray-100 w-full py-4 rounded-lg hover:bg-primary-900 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none mt-auto sm:text-lg rounded-none w-full rounded sm:rounded-none sm:rounded-br-4xl py-3 sm:py-6`}
  .text {
    ${tw`ml-3`}
  }
`;
        ...
        <CardSlider ref={setSliderRef} {...sliderSettings}>
          {cards.map((card, index) => (
            <Card key={index}>
              ...
              <PrimaryButton href="/verify">Book Now</PrimaryButton>
            </Card>
          ))}
        </CardSlider>
      </Content>
